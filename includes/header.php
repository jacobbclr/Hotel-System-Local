...
<head>
    ...
    <script src=".\node_modules\flowbite\dist\datepicker.js"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
</head>

<body class="dark:bg-gray-900 bg-gray-50 h-screen">
    <?php
    $activePage = basename($_SERVER['PHP_SELF']);
    // Display the navigation bar only if the user is authenticated
    if (isset($_SESSION["user_id"]) && !empty($_SESSION["user_id"])) {
        // Include or echo your navigation bar HTML code here
        // For example:
        ?>
        ...
        <aside id="separator-sidebar"
            ...
            <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                <a href="https://flowbite.com/" class="flex items-center ps-2.5 mb-5">
                    <svg class="h-6 me-3 sm:h-7 text-gray-800 dark:text-white" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                        <path
                            d="M18 0H2a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2Zm-5.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Zm4.376 10.481A1 1 0 0 1 16 15H4a1 1 0 0 1-.895-1.447l3.5-7A1 1 0 0 1 7.468 6a.965.965 0 0 1 .9.5l2.775 4.757 1.546-1.887a1 1 0 0 1 1.618.1l2.541 4a1 1 0 0 1 .028 1.011Z" />
                    </svg>
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Ihr Branding</span>
                </a>
                <ul class="space-y-2 font-medium">
                    <li>
                        <a href="home.php"
                            class="<?php if ($activePage == 'home.php')
                                echo 'bg-gray-100 dark:bg-gray-700'; ?>  flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span class="ms-3">Übersicht</span>
                        </a>
                    </li>
                    <li>
                        <a href="bookings.php"
                            class="<?php if ($activePage == 'bookings.php')
                                echo 'bg-gray-100 dark:bg-gray-700'; ?>  flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span class="ms-3">Buchungen</span>
                        </a>
                    </li>
                    <li>
                        <a href="calender.php"
                            class="<?php if ($activePage == 'calender.php')
                                echo 'bg-gray-100 dark:bg-gray-700'; ?> flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            ...
                            <span
                                class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">Neu</span>
                        </a>
                    </li>
                    <li>
                        <a href="inbox.php"
                            class="<?php if ($activePage == 'inbox.php')
                                echo 'bg-gray-100 dark:bg-gray-700'; ?> flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap">Nachrichten</span>
                            <span
                    ...
                    <li>
                        <a href="documents.php"
                            class="<?php if ($activePage == 'documents.php')
                                echo 'bg-gray-100 dark:bg-gray-700'; ?> flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 20 16">
                    ...
                    <li>
                        <a href="todo.php"
                            class="<?php if ($activePage == 'todo.php')
                                echo 'bg-gray-100 dark:bg-gray-700'; ?> flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white aria-hidden="
                                true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 21 21">
                    ...
                    <li>
                        <a href="users.php"
                            class="<?php if ($activePage == 'users.php')
                                echo 'bg-gray-100 dark:bg-gray-700'; ?> flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 20 18">
                ...
                <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                    <li>
                        <a href="profile.php"
                            class="<?php if ($activePage == 'profile.php')
                                echo 'bg-gray-100 dark:bg-gray-700'; ?> flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path
                    ...
                    <li>
                        <a href="logout.php"
                            class="<?php if ($activePage == 'logout.php')
                                echo 'bg-gray-100 dark:bg-gray-700'; ?> flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 20 20">
                    ...
                    <li>
                        <a href="help.php"
                            class="<?php if ($activePage == 'help.php')
                                echo 'bg-gray-100 dark:bg-gray-700'; ?> flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 21 21">
